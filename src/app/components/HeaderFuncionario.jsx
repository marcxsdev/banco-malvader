    ...
    <div className="flex flex-row items-center justify-between px-26 py-4 border-b">
      ...
      <Link href="/pages/login">
        <button
          ...
          className="bg-black flex flex-row items-center justify-center gap-4 py-2.5 px-8 max-h-[45px] rounded-xl cursor-pointer hover:bg-neutral-800 hover:scale-105 transition duration-300"
        >
